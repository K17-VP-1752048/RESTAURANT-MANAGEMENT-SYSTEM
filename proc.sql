...
begin tran
	...
	declare @soluonghienco int = (select soluong from SLMonAnTrongNgay where  IDchinhanh = @chinhanhduocchon and IDmon = @IDmon)
...
go
exec DatMon 'DH4', 'Mon1', 3
exec xemmenutheochinhanh null,'CN1',null,null,null
